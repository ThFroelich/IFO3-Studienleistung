...
namespace Firmenverwaltung {
	...
	/// <summary>
	/// Zusammenfassung für NeuerEintrag
	/// </summary>
	public ref class NeuerEintrag : public System::Windows::Forms::Form
	{
	public:
		NeuerEintrag(void)
		{
	...
	private: System::Windows::Forms::ComboBox^  cbMitarbeiterAbteilung;
	...
	private: System::Windows::Forms::ComboBox^  cbAbteilungsleiterAbteilung;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->cbMitarbeiterAbteilung = (gcnew System::Windows::Forms::ComboBox());
			...
			this->cbAbteilungsleiterAbteilung = (gcnew System::Windows::Forms::ComboBox());
			...
			this->pnlMitarbeiter->Controls->Add(this->cbMitarbeiterAbteilung);
			...
			this->pnlMitarbeiter->TabIndex = 0;
			// 
			// label13
			// 
			...
			// 
			// cbMitarbeiterAbteilung
			// 
			this->cbMitarbeiterAbteilung->FormattingEnabled = true;
			this->cbMitarbeiterAbteilung->Location = System::Drawing::Point(275, 287);
			this->cbMitarbeiterAbteilung->Name = L"cbMitarbeiterAbteilung";
			this->cbMitarbeiterAbteilung->Size = System::Drawing::Size(121, 21);
			this->cbMitarbeiterAbteilung->TabIndex = 22;
			// 
			// label10
			// 
			...
			this->pnlAbteilungsleiter->Controls->Add(this->cbAbteilungsleiterAbteilung);
			...
			// 
			// cbAbteilungsleiterAbteilung
			// 
			this->cbAbteilungsleiterAbteilung->FormattingEnabled = true;
			this->cbAbteilungsleiterAbteilung->Location = System::Drawing::Point(275, 287);
			this->cbAbteilungsleiterAbteilung->Name = L"cbAbteilungsleiterAbteilung";
			this->cbAbteilungsleiterAbteilung->Size = System::Drawing::Size(121, 21);
			this->cbAbteilungsleiterAbteilung->TabIndex = 22;
			// 
			// label17
			// 
			...
			// btnSpeichern
			// 
			this->btnSpeichern->Location = System::Drawing::Point(12, 84);
			...
			this->btnAbbrechen->Click += gcnew System::EventHandler(this, &NeuerEintrag::btnAbbrechen_Click);
			// 
			// rbMitarbeiter
			// 
			...
			this->rbMitarbeiter->TabIndex = 4;
			this->rbMitarbeiter->TabStop = true;
			this->rbMitarbeiter->Text = L"Mitarbeiter";
			this->rbMitarbeiter->UseVisualStyleBackColor = true;
			this->rbMitarbeiter->CheckedChanged += gcnew System::EventHandler(this, &NeuerEintrag::rbMitarbeiter_CheckedChanged);
			// 
			// rbAbteilungsleiter
			// 
			...
			this->rbAbteilungsleiter->TabIndex = 5;
			...
			this->rbAbteilungsleiter->CheckedChanged += gcnew System::EventHandler(this, &NeuerEintrag::rbAbteilungsleiter_CheckedChanged);
			// 
			// rbAbteilung
			// 
			...
			this->rbAbteilung->TabIndex = 6;
			this->rbAbteilung->TabStop = true;
			this->rbAbteilung->Text = L"Abteilung";
			this->rbAbteilung->UseVisualStyleBackColor = true;
			this->rbAbteilung->CheckedChanged += gcnew System::EventHandler(this, &NeuerEintrag::rbAbteilung_CheckedChanged);
			// 
			// pnlAbteilung
			// 
			...
			this->Name = L"NeuerEintrag";
			this->Text = L"NeuerEintrag";
			this->Load += gcnew System::EventHandler(this, &NeuerEintrag::NeuerEintrag_Load);
...
private: System::Void NeuerEintrag_Load(System::Object^  sender, System::EventArgs^  e) {
