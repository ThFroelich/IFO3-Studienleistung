...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->rbAbteilung->TabIndex = 41;
			this->rbAbteilung->TabStop = true;
			this->rbAbteilung->Text = L"Abteilung";
			this->rbAbteilung->UseVisualStyleBackColor = true;
			this->rbAbteilung->CheckedChanged += gcnew System::EventHandler(this, &Suchen::rbAbteilung_CheckedChanged);
			// 
			// rbAbteilungsleiter
			// 
			...
			this->rbAbteilungsleiter->TabIndex = 40;
			...
			this->rbAbteilungsleiter->CheckedChanged += gcnew System::EventHandler(this, &Suchen::rbAbteilungsleiter_CheckedChanged);
			// 
			// rbMitarbeiter
			// 
			...
			this->rbMitarbeiter->TabIndex = 39;
			this->rbMitarbeiter->TabStop = true;
			this->rbMitarbeiter->Text = L"Mitarbeiter";
			this->rbMitarbeiter->UseVisualStyleBackColor = true;
			this->rbMitarbeiter->CheckedChanged += gcnew System::EventHandler(this, &Suchen::rbMitarbeiter_CheckedChanged);
			// 
			// btnAbbrechen
			// 
			...
			this->btnAbbrechen->Click += gcnew System::EventHandler(this, &Suchen::btnAbbrechen_Click);
			// 
			// pnlMitarbeiter
			// 
			...
			this->pnlMitarbeiter->TabIndex = 37;
			// 
			...
			this->tbMitarbeiterAbteilung->TabIndex = 38;
			// 
			// label13
			// 
			...
			this->label33->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label33->Location = System::Drawing::Point(17, 18);
			...
			this->tbSuchEingabe->TabIndex = 44;
			// 
			// Suchen
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(695, 518);
